...
void Display()
{
	...
	float eyeX = EyeX.GetValue(nowSecs);
	float eyeY = EyeY.GetValue(nowSecs);
	float eyeZ = EyeZ.GetValue(nowSecs);
	...
	for (int i = 0; i < NUM_HORSES; ++i) {
		glPushMatrix();
		glRotatef(HThetaX[i].GetValue(nowSecs), 1.f, 0.f, 0.f);
		glRotatef(HThetaY[i].GetValue(nowSecs), 0.f, 1.f, 0.f);
		glRotatef(HThetaZ[i].GetValue(nowSecs), 0.f, 0.f, 1.f);
